...
function ProductCardAdmin({data,fetchProductData}) {
  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
      ...
      {
        openDelete && (
          <section className='fixed top-0 left-0 bottom-0 right-0 bg-neutral-600 z-50 bg-opacity-70 p-4 flex justify-center items-center '>
              <div className='bg-white p-4 w-ful max-w-md rounded-md'>
