...
function DisplayCartItem({ close }) {
   ...
   const navigate = useNavigate()
    ...
    return (
        <section className='bg-neutral-900 fixed top-0 right-0 left-0 bottom-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                                ...
                                <div className='bg-white rounded-lg p-4 grid gap-5 overflow-auto'>
                                    {
                                        cartItem[0] && (
                                            cartItem.map((item, idx) => {
                                                return (
                                                    <div key={item?._id + idx} className='flex w-full gap-4'>
...

                {
                    ...
                    <div className='bg-green-700 text-neutral-100 px-4 font-bold text-base static bottom-3 rounded flex items-center gap-4 justify-between py-4'>
                        <div>
